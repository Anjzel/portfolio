				...
				>
					...
					<div className="relative z-10">
						...
						<div className="font-mono">
							...
							>
								denzelconcepcion8@gmail.com
							</motion.a>
							<p className="text-green-500 mt-8 mb-2">$  resume.pdf</p>
							<motion.a
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
								...
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">@anjzel</p>
									</div>
								</motion.a>
								<motion.a
								...
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">Denzel Concepcion</p>
									</div>
								</motion.a>
								<motion.a
