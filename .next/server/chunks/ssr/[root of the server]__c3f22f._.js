...
;
const metadata = {
    title: 'Denzel Concepcion - Backend Developer',
    description: 'Welcome to my portfolio! I am a passionate backend developer specializing in building scalable server architectures, robust APIs, and high-performance distributed systems. With expertise in cloud infrastructure and database optimization, I create efficient and reliable backend solutions.',
    keywords: [
        'Backend Developer',
        'Software Engineer',
        'System Architecture',
    ...
    authors: [
        {
            name: 'Denzel Concepcion'
        }
    ],
    creator: 'Denzel Concepcion',
    openGraph: {
        title: 'Denzel Concepcion - Backend Developer Portfolio',
        ...
        siteName: 'Denzel Concepcion - Portfolio',
        images: [
            {
                url: '/og-image.jpg',
                width: 1200,
                height: 630,
                alt: 'Denzel Concepcion - Backend Developer Portfolio'
            }
        ],
        locale: 'en_US',
        type: 'website'
